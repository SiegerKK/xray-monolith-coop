...
private:
	...
	u32 m_coop_render_event_count = 0;
...
IC bool IsGameTypeSingleOrCoop() { return (g_pGamePersistent->GameType() == eGameIDSingle || g_pGamePersistent->GameType() == eGameIDCooperative); }
